        ...
        <div className="  min-h-screen">
            ...
            <section className=" p-8   bg-gray-100   text-gray-800">
                <div className="container mx-auto p-4 my-6 space-y-2 text-center">
                    ...
                    <p className="font-noto text-gray-600">Kendi projelerinizi geliştirerek teknoloji dünyasında yerinizi alın.</p>
                </div>
            ...
            <section className="py-12 text-white bg-[#0277BD] text-center">
                ...
                <p className="text-lg  font-noto mb-6">Teknoloji dünyasında bir adım önde olun ve kendi robotlarınızı tasarlayın.</p>
